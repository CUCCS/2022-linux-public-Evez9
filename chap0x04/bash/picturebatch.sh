...
describe() {
    cat << EOF
    Description:
        Use bash to write a picture batch script to realize the function of processing pictures
    Usage:
    ...
    Arguments:
        ...
        position    The position of the watermark,you can input 'NorthWest, North, NorthEast, West, East, SouthWest, South, SouthEast'
